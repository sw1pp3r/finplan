...
## Users
One person (sw1pp3r), planning his money privately on a tailnet-only app. Most screens are dry, fast, dense (snapshots, obligations, inflows, course economics). The board is where he looks at *why* he's saving — his dreams — so it should feel aspirational, not like another spreadsheet.
...
2. **Bright images stay bright.** sw1pp3r chose undarkened photos with readable captions; keep that. Drama comes from atmosphere, typography, light, and hierarchy — not by darkening the photos.
