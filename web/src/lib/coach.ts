...
export const COACH_STEPS: CoachStep[] = [
  ...
  },
  {
    ...
    how: "Форма уже открыта: впишите название, сумму, дату и период, затем «Добавить».",
  },
  {
    route: "/income",
    target: "income-form",
    ...
    how: "Форма уже открыта: впишите источник, сумму и дату, выберите тип (разовый или регулярный) и нажмите «Добавить доход».",
  },
]
